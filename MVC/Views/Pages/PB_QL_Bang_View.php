...
<head>
    ...
    <div class="w3-container">
      <br>
    <h1><b>QUẢN LÝ BẰNG TỐT NGHIỆP</b></h1>
    <form action="http://localhost/congnghephanmem/PB_QL_Bang/fillter/" method="post">
...
<div class="container mt-3">
        ...
        <td id="wrap"><?php echo $row['MaBang'];?></td>
        <td id="wrap"><?php echo $row['LoaiBang'];?></td>
        <td id="wrap"><?php echo $row['XepHang'];?></td>
        <td id="wrap"><?php echo $row['NgayCapBang'];?></td>
        <td id="wrap"><?php echo $row['TrangThai'];?></td>
